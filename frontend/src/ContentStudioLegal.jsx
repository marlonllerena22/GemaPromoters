...
const termsSections = [
  ...
  ['Publicación en redes', 'La publicación ocurre únicamente cuando eliges las cuentas, revisas el copy y pulsas Publicar. Meta puede rechazar contenido o limitar permisos según sus propias políticas.'],
