...
import { BriefcaseBusiness, CalendarCheck, Check, ClipboardCheck, DollarSign, Home, LogOut, MapPin, Plus, RefreshCw, Sparkles, TrendingUp, UserRound, UsersRound } from 'lucide-react';
...
export default function ContentStudioSellerApp({ user, onLogout }) {
  ...
  const navigation = [['home', 'Inicio', Home], ['activity', 'Actividad', ClipboardCheck], ['sales', 'Ventas', DollarSign], ['profile', 'Perfil', UserRound]];
  return <div className="css-app">
    ...
    <main className="css-main">
      ...
      {!data ? <div className="css-loading"><Sparkles/> Preparando tu panel...</div> : <>
        {tab === 'home' && <HomeView summary={summary} goals={goals} period={data.period} activities={data.activities} sales={data.sales} onAddActivity={() => setTab('activity')} onAddSale={() => setTab('sales')} reload={load}/>} 
